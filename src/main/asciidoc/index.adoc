...
When you stand up a web service, people will want to see how to use it.
Thanks to Spring REST Docs, you can generate all the interactions needed via test cases that in turn
...
By running the following HATEOAS request:
